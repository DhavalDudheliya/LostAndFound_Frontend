...
function ClaimedItemsAdmin() {
  ...
  useEffect(() => {
    axios
      .get(`/admin/getClaimedItems`) // Here i use same route that used in Coordinator
      .then((res) => {
  ...
  const ifQueryEmpty = async () => {
    axios
      .all([axios.get(`/admin/getClaimedItems`)]) // Here i use same route that used in Coordinator
      .then(
        axios.spread((res1) => {
  ...
  const handleSearch = async () => {
    ...
    axios
      .all([
        axios.get(
          `/admin/getClaimedItemsBySearch?q=${query}` // Here i use same route that used in Coordinator
        ),
      ])
      .then(
        axios.spread((res1) => {
